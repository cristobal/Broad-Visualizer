package com.gran
{
	import com.gran.core.Simulation;
	import com.gran.core.aggregate.Aggregate;
	import com.gran.core.events.TimedEvent;
	...
	import com.gran.core.parser.TraceSourceParser;
	import com.gran.elements.buffer.Buffers;
	import com.gran.elements.buffer.BuffersDataProvider;
	import com.gran.elements.drops.Drops;
	import com.gran.elements.drops.DropsDataProvider;
	import com.gran.elements.mobility.Mobility;
	import com.gran.elements.mobility.MobilityArea;
	import com.gran.elements.mobility.Waypoint2D;
	import com.gran.elements.receptions.Receptions;
	import com.gran.elements.receptions.ReceptionsDataProvider;
	import com.gran.elements.routing.Routing;
	import com.gran.elements.routing.RoutingTable;
	import com.gran.elements.routing.RoutingTableEntry;
	import com.gran.elements.routing.SimpleRoute;
	import com.gran.elements.sequences.SequencesContainer;
	import com.gran.elements.sequences.providers.SequencesForwardedDataProvider;
	import com.gran.elements.sequences.providers.SequencesInsertedDataProvider;
	import com.gran.elements.sequences.providers.SequencesRecvDataProvider;
	import com.gran.elements.sequences.providers.SequencesSentDataProvider;
	...
	import com.gran.elements.transmissions.Transmissions;
	import com.gran.elements.transmissions.TransmissionsBitrateDataProvider;
	import com.gran.elements.transmissions.TransmissionsDataProvider;
	import com.gran.io.FileReferenceReader;
	import com.gran.io.Reader;
	import com.gran.ui.menus.Playback;
	import com.gran.ui.menus.PlaybackContainer;
	import com.gran.ui.menus.ProgressTimeSlider;
	import com.gran.view.VisualizerView;
	import com.gran.view.components.GridView;
	import com.gran.view.components.LoaderView;
	import com.gran.view.components.MiniMapView;
	import com.gran.view.components.NodeSprite;
	import com.gran.view.components.NodeView;
	import com.gran.view.components.PerimeterView;
	import com.gran.view.components.StatsView;
	import com.gran.view.drawing.NodeBuffersDrawingManager;
	import com.gran.view.drawing.NodeDrawingManager;
	import com.gran.view.drawing.NodeDropsDrawingManager;
	import com.gran.view.drawing.NodeIDDrawingManager;
	import com.gran.view.drawing.NodeMobilityDrawingManager;
	import com.gran.view.drawing.NodeReceptionsDrawingManager;
	import com.gran.view.drawing.NodeRoutingDrawingManager;
	import com.gran.view.drawing.NodeTransmissionsDrawingManager;
	...
	public final class Gran
	{
		 ...
		 * @param window
		 */ 
		public function Gran(app:Application, window:ApplicationWindow)
		{		
			setup(window);
			bindWindow(window);
